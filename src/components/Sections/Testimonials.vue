<template>
    <section class="py-4 bg-gray-50 sm:py-16 lg:py-20">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex flex-col items-center">
                <div class="text-center">
                    <p class="text-lg font-medium text-gray-600 font-pj">207 people have said how good WISCOPREC is</p>
                    <h2 class="mt-4 text-3xl font-bold text-gray-500 sm:text-4xl xl:text-5xl font-pj">Our happy clients say about us</h2>
                </div>
    
                <div class="mt-8 text-center md:mt-16 md:order-3">
                    <router-link :to="{name: 'about'}" title="" class="pb-2 text-base font-bold leading-7 text-gray-900 transition-all duration-200 border-b-2 border-gray-900 hover:border-gray-600 font-pj focus:outline-none focus:ring-1 focus:ring-gray-900 focus:ring-offset-2 hover:text-gray-600"> Check all reviews </router-link>
                </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <blockquote class="flex-1 mt-8">
                                        <p class="text-lg leading-relaxed text-gray-900 font-pj">                                            
                                            "The preparation classes at WISCOPREC were intense, but they equipped me with the knowledge and skills I needed to excel in my exams. I am grateful for the experience."
                                        </p>
                                    </blockquote>
                                </div>
    
                                <div class="flex items-center mt-8">
                                    <img class="flex-shrink-0 object-cover rounded-full w-11 h-11" src="../../assets/img/team/junior.jpeg" alt="" />
                                    <div class="ml-4">
                                        <p class="text-base font-bold text-gray-900 font-pj">Engr. Foryoung Junior</p>
                                        <p class="mt-0.5 text-sm font-pj text-gray-600">CTO Traitz Tech</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col overflow-hidden shadow-xl">
                            <div class="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                                <div class="flex-1">
                                    ...
                                    <blockquote class="flex-1 mt-8">
                                        <p class="text-lg leading-relaxed text-gray-900 font-pj">"WISCOPREC was a transformative experience. The rigorous preparation for competitive exams pushed me to my limits, but ultimately made me a stronger candidate."</p>
                                    </blockquote>
                                </div>
                                ...
                                <div class="flex items-center mt-8">
                                    ...
                                    <div class="ml-4">
                                        <p class="text-base font-bold text-gray-900 font-pj">Engr. Fonguong Edrick</p>
                                        <p class="mt-0.5 text-sm font-pj text-gray-600">C.E.O</p>
                                    </div>
                                </div>
                            </div>
                        </div>
